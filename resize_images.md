...
`resize_images.py` is a utility script to resize images in a directory. It supports resizing based on a maximum dimension and can convert HEIC images to JPEG.
